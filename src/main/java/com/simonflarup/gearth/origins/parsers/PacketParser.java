package com.simonflarup.gearth.origins.parsers;
...
public class PacketParser {
    ...
    protected PacketParser(int expectedHeaderId, ShockPacket packet) {
    ...
    protected void warnAboutUnparsedData(ShockPacket packet) {
